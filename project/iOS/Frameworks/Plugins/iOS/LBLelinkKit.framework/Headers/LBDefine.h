...
// 支持Airplay投屏,对外sdk不打开,内部APP使用，按需打开，APP打包不修改该值，默认1
#define LCLINKFP 0
// quic 开关 对外 SDK 不打开，内部 App 使用，按需打开，默认1（ 1-编译quic代码 0-不编译）
#define QUIC 0
...
// 打开APP外镜像限制， 对外sdk需打开，内部APP需关闭，APP打包不修改该值，默认0
#define OPENAPPEXTERNALLIMIT 0
